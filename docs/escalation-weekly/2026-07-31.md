...
|---|---|---|---|---|
| `e7-p2-01` | auto_resolve | 0.5546 | 5/5 | — |
| `e7-p2-02` | auto_resolve | 0.4543 | 5/5 | — |
| `e7-p2-03` | auto_resolve | 0.5227 | 5/5 | — |
| `e7-p2-04` | auto_resolve | 0.5060 | 5/5 | — |
...
|---|---|---|---|---|---|
| `e7-p3-01` | auto_resolve | 0.4607 | 5/5 | — | ❌ false-resolve |
| `e7-p3-02` | auto_resolve | 0.4214 | 5/5 | — | ❌ false-resolve |
| `e7-p3-03` | auto_resolve | 0.4298 | 5/5 | — | ❌ false-resolve |

**Verdict:** false-resolve 100% (3/3); 0 correctly escalated at the faithfulness gate — FALSE-RESOLVE (safety): `e7-p3-01`, `e7-p3-02`, `e7-p3-03`.
...
| false_resolve | 100% | 3/3 | 🔒 safety (pinned) | P1a 0/3 [monitor-only], P1b 0/4 [monitor-only], P3 3/3 |
...
- Measured false-resolve (faithfulness leg, P3): **100% (3/3)**
...
**Knee:** τ_sim=0.5, N_min=1, faithfulness≥4/5 → deflection 75%, false-resolve 0% (≤ ceiling 5%).
**Recommended US-050 defaults:** `ESCALATION_TAU_SIM=0.5`, `ESCALATION_N_MIN=1`. The offline faithfulness floor (4/5) is guidance only — the runtime `ESCALATION_FAITHFULNESS_CUTOFF` is a different [0,1] scale (US-048/050), tuned separately.
