...
# five modules the per-PR `eval-harness-guards` job runs. The first two pin the
# rule that a harness which measured nothing must refuse to publish a number for
# it; the last three pin the issue-#104 safety-gate properties.
